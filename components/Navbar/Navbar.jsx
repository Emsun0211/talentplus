...
export const Navbar = () => {
	...
	return (
		<div
			className={`z-40 fixed top-0 ${scrollBg} left-0 right-0 pt-[1.5rem] pb-[1rem]  pb-2 px-[2rem] ease-in duration-300`}>
				...
				<div className='cursor-pointer'>
					<div className='hidden sm:flex justify-between gap-x-5 lg:gap-x-10 '>
						<ul className='flex items-center justify-between gap-x-5 lg:gap-x-10 text-[14px] lg:text-[1.1rem] text-white'>
							<li className='p-2 hover:bg-white hover:text-[#004DB3] rounded-[5px] ease-in duration-300'>
								Home
							</li>
							<li className='p-2 hover:bg-white hover:text-[#004DB3] rounded-[5px] ease-in duration-300'>
								About Us
